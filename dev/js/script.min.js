...
window.onload = function () {
  ...
  var modalGlr = document.querySelector('.modal-slider');
  var imgGlr = modalGlr.querySelector('img');
  var arrGlr = document.querySelectorAll('.portfolio__img');
  var closeGlr = modalGlr.querySelector('.icon-error');
  var modalPrev = modalGlr.querySelector('.modal-slider__icon-prev');
  var modalNExt = modalGlr.querySelector('.modal-slider__icon-next');

  closeGlr.onclick = function () {
  ...
  var arrImg = [];
  arrGlr.forEach(function (item) {
    arrImg.push(item.getAttribute('src'));
  });

  modalPrev.onclick = function () {
    var imgCurrent = imgGlr.getAttribute('src');
    var imgIndex = arrImg.indexOf(imgCurrent);
