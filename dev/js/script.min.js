...
window.onload = function () {
  ...
  var galleriBlockWork = carouselWork.querySelector('.portfolio__gallery');
  ...
  var carouselReview = document.querySelector('.reviews__carusel');
  var listReview = carouselReview.querySelector('.reviews__slider');
  var listElemsReview = carouselReview.querySelectorAll('.reviews__item');
  var galleriBlockReview = carouselReview.querySelector('.reviews__gallery');
  var btnPrevReview = carouselReview.querySelector('.reviews__arrow-prev');
  var btnNextReview = carouselReview.querySelector('.reviews__arrow-next');
  var btnLoadReview = document.querySelector('.reviews__btn-load');
  var positionReview = 0;
  var heightReview = 149;
  var countReview = 2;
  ...
  btnNextReview.onclick = function () {
    positionReview -= heightReview * countReview;
    var disPointReview = listElemsReview.length * heightReview;
  ...
  btnLoadReview.onclick = function () {
    var arrClass = [];
    listElemsReview.forEach(function (item, ind) {
    ...
    if (arrClass.length < listElemsReview.length) {
      var diffLength = listElemsReview.length - arrClass.length;
      ...
      if (diffLength > 3) {
        ...
        for (var _i2 = arrClass.length; _i2 < arrClass.length + diffLength; _i2++) {
          listElemsReview[_i2].classList.remove('reviews__item-close');

          listElemsReview[_i2].classList.add('reviews__item-open');
        }
      }
    }
  }; // CAROUSEL REVIEW END
